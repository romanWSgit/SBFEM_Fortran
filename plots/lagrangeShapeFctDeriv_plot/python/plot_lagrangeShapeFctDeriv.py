...
input_file = "/Users/roman_w_s/Developer/FORTRAN/SBFEM/plots/data/lagrangeShapeFctDeriv.dat"
...
plt.title("Lagrangian Shape functions derivative")
plt.legend(legend_arr,bbox_to_anchor=(1.04, 0.5), loc="center left")
plt.xlabel("x")
plt.ylabel("f(x)")
plt.grid(True, linestyle='--')
plt.xlim([-1, 1])
plt.savefig("/Users/roman_w_s/Developer/FORTRAN/SBFEM/plots/images/lagrangeShapeFctDeriv_py.svg",bbox_inches="tight")
